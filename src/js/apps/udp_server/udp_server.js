...
export class UDP_Server_ID extends App_ID_Template
{
...
export class UDP_Server
{
    ...
    {
        let client = this._clients.find(c => c.is_equal(addr, port));
        if(client) return false;
        
        this._clients.push(new UDP_Server_Client(addr, port));
        return true;
    }
    
    remove_client(addr, port)
    {
        this._clients = this._clients.filter(c => !c.is_equal(addr, port));
    }
...
export class UDP_Server_Client
{
